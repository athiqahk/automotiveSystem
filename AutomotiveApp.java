...
public class AutomotiveApp {
            ...
            if(Q1.equalsIgnoreCase("Yes") || Q1.equalsIgnoreCase("yes")) {
                ...
                if(staffFound) {    
                    ...
                    if(Q2.equalsIgnoreCase("Yes") || Q2.equalsIgnoreCase("yes")) {
                        ...
                        // Sort, Traverse and Print the list
                        System.out.println("\nList sorted by year:");
                        System.out.println("==================================================================================================================================================================================================================================================");
                        System.out.println(String.format("|%-10s|%-25s|%-25s|%-25s|%-25s|%-25s|%-25s|%-25s|%-15s|%-15s|%-15s|","CODE","VEHICLE TYPE","BRAND","MODEL NAME","YEAR LAUNCHED","CAPACITY(CC)","FUEL TYPE","DESIGN COLOUR","TINTED","CONDITION","PRICE(RM)"));
                        System.out.println("==================================================================================================================================================================================================================================================");
    ...
    //Creates and returns a JLabel with the specified text, aligned to the left.
    private static JLabel createLabel(String text) {
        JLabel label = new JLabel(text);
        label.setAlignmentX(Component.LEFT_ALIGNMENT);
        return label;
    }
    //Creates and returns a JTextField embedded in a JPanel with a specified label and prompt text.
    private static JTextField createInputField(String labelText, String promptText) {
        ...
        // Create a JLabel with the specified label text
        JLabel label = new JLabel(labelText + ": ");
        
        // Create a JTextField with an initial width of 15 characters
        JTextField textField = new JTextField(15);
        
        // Set the prompt text as a tooltip for the JTextField
        textField.setToolTipText(promptText);
        
        // Add the label and the text field to the input panel
        inputPanel.add(label);
        inputPanel.add(textField);
        
        // Align the input panel to the left within its container
        inputPanel.setAlignmentX(Component.LEFT_ALIGNMENT);
    
        // Return the JTextField directly
        return textField;
    }
    //Creates and displays a graphical user interface (GUI) for adding a new automotive entry.
    private static void createAndShowAddEntryGUI(LinkList automotiveList) throws IOException {
        ...
        String pass = getPasswordInput("Enter Password");
        if (!pass.equalsIgnoreCase("AutoNAStaff")) {
            JOptionPane.showMessageDialog(frame, "Incorrect Password. Access denied.");
            return; // Terminate method if authentication fails
        }
        ...
        // Create and configure the "Add Entry" button
        ...
        addButton.addActionListener(e -> {
            ...
            // Display the details of the new entry in the console
            System.out.println("\nNew Entry Details:");
            System.out.println("==================================================================================================================================================================================================================================================");
            System.out.println(String.format("|%-10s|%-25s|%-25s|%-25s|%-25s|%-25s|%-25s|%-25s|%-15s|%-15s|%-15s|","CODE","VEHICLE TYPE","BRAND","MODEL NAME","YEAR LAUNCHED","CAPACITY(CC)","FUEL TYPE","DESIGN COLOUR","TINTED","CONDITION","PRICE(RM)"));
            System.out.println("==================================================================================================================================================================================================================================================");
            ...
            // Display the number of vehicles in the list
            int numberOfNodes = automotiveList.countNodes();
            System.out.println("Number of vehicles: " + numberOfNodes);
        });
        // Add the "Add Entry" button to the panel
        panel.add(addButton);
    ...
    private static void saveEntryToFile(Automotive automotive, String fileName) {
        try (PrintWriter writer = new PrintWriter(new FileWriter(fileName, true))) {
            ...
            String formattedPrice = df.format(automotive.getPrice());
            writer.println(String.format("%d;%s;%s;%s;%d;%.2f;%s;%s;%c;%c;%.2f",
                    ...
                    automotive.getCondition(), formattedPrice));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
